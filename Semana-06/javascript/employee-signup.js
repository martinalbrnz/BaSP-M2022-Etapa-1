window.onload = function () {
	...
	function validateSurname() {
		if (signupSurname.value == '') {
			...
			signupSurnameInlineAlert.textContent = 'Surname must have at least 3 characters';
			signupSurname.insertAdjacentElement('afterend', signupSurnameInlineAlert);
		}
	...
	function validateIDNumber() {
		if (signupIDNumber.value == '') {
			...
			signupIDNumberInlineAlert.textContent = 'ID Number must have at least 8 characters';
			signupIDNumber.insertAdjacentElement('afterend', signupIDNumberInlineAlert);
		}
	...
	function validatePhone() {
		if (signupPhone.value == '') {
			...
			signupPhoneInlineAlert.textContent = 'Phone number must have 10 characters';
			signupPhone.insertAdjacentElement('afterend', signupPhoneInlineAlert);
		}
	...
	function validateZipCode() {
		...
		else if (!(signupZip.value.length <= 5 & signupZip.value.length >= 4)){
	...
	// DUMMY FUNCTION, I MUST ERASE THIS BEFORE PUSHING OR I WILL CRY
	function brooooo(){
		console.log('BROOO!');
	}
}
